...
public class Item {
	...
	public static class ItemBuilder {
		...
		public Item build() {
			return new Item(this);//return item itself
		}
	}
//ItemBuilder builder = new ItemBuilder().setname("").setID()
	// new an IntemBuilder() instance, and call setname, the setname will return ItemBuilder and the ItemBuilder will call setID
	// setID will return ItemBuilder to builder
	//At last,  Item item = builder.builder(), and  it will return Item   64:00
}
